...
[Code of Conduct](https://github.com/sahil-me/ProductService/blob/main/CODE_OF_CONDUCT.md).**
...
on GitHub under Issues). Your issue should also be related to bugs in the service itself, and not issues caused by unrelated application 
code. 
...
2. **Clone your forked Repository**
   ```bash
   git clone https://github.com/<username>/ProductService.git
   ```
